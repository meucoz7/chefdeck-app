  ...
  useEffect(() => {
    if (id) {
      ...
      if (recipeRef) {
        ...
        setIsArchived(!!recipe.isArchived);
      }
    }
  }, [id, getRecipe]);
  ...
  return (
    <div className="pb-safe-bottom animate-slide-up mx-auto min-h-screen relative bg-[#f2f4f7] dark:bg-[#0f1115]">
      ...
      <div className="px-5 pt-safe-top flex justify-between items-center mb-2">
        <button onClick={handleBack} disabled={isImporting || isSaving || isUploading || isParsing} className="flex items-center gap-2 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition group py-2">
